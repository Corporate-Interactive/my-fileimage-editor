...
export type SuggestionsFilterFnType = (suggestions: TagType[], userInput: string, getTagLabel: (tag: TagType) => string, alwaysShowSuggestedTags: boolean) => TagType[];
export interface TagFieldProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'onBlur'> {
    ...
    onRemove: (index: number, value: string, setUserInput: React.Dispatch<React.SetStateAction<string>>, event: any) => void;
