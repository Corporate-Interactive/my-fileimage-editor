...
var Calendar = intrinsicComponent(function (_ref, ref) {
  ...
  var _useState7 = useState(getMaxMinSelectedDay(maxDate, minDate, monthDetails, maxDay, minDay, autoSelectToday)),
  ...
  var prevMonthTimestamp = getNextPrevSelectedDayTimeStamp(year, month, 0);
