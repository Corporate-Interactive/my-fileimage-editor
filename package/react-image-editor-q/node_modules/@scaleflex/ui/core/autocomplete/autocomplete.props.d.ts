...
export interface AutocompleteProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'onChange'> {
    ...
    onClose?: (event: React.SyntheticEvent<HTMLElement> | React.KeyboardEvent<HTMLElement> | React.MouseEvent<HTMLElement> | undefined) => void;
    ...
    renderLabelIconEnd?: ({ option, isMultiple, }: {
    ...
    hideArrow?: boolean;
    renderTag?: ({ id, label, option, size, onRemove, }: {
    ...
    renderMenuItem?: ({ id, label, option, menuItemProps, }: {
        id: AutocompleteOptionIdType;
...
export interface AutocompleteHookReturn {
    ...
    handleCloseMenuClick: (event?: React.SyntheticEvent<HTMLInputElement> | React.KeyboardEvent<HTMLInputElement> | React.MouseEvent<HTMLDivElement>) => void;
    ...
    handleOnRemoveItem: (event: React.SyntheticEvent<HTMLElement> | React.MouseEvent<SVGSVGElement>, optionId: AutocompleteOptionIdType) => void;
    handleOnBlur: () => void;
