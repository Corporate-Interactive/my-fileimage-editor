...
var Tabs = intrinsicComponent(function (_ref, ref) {
  ...
  return /*#__PURE__*/React.createElement(Styled.Tabs, _extends({
    ...
    var childValue = (child === null || child === void 0 ? void 0 : child.props.value) || index;
    ...
    return /*#__PURE__*/React.cloneElement(child, _objectSpread({
      onClick: function onClick(event) {
        ...
        if (typeof (child === null || child === void 0 ? void 0 : child.props.onClick) === 'function') {
          child === null || child === void 0 || child.props.onClick(event);
        }
      }
